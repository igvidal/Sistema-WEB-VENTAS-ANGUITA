        ...
        <div class="column is-one-quarter">
            ...
            <?php } ?>
                ...
                <div class="control mb-5">
                    ...
                    <input class="input" type="text" name="venta_abono" id="venta_abono" value="0" pattern="[0-9.]{1,25}" maxlength="25" >
                </div>

                <div class="control mb-5">
                    <label>Vuelto a cliente</label>
                    <input class="input" type="text" id="venta_cambio" value="0" readonly >
                </div>
